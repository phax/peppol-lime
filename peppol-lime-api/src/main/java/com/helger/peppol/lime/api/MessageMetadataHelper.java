...
{
  private static final QName QNAME_MESSAGEID = com.helger.peppol.identifier.ObjectFactory._MessageIdentifier_QNAME;
  private static final QName QNAME_CHANNELID = com.helger.peppol.identifier.ObjectFactory._ChannelIdentifier_QNAME;
  private static final QName QNAME_RECIPIENTID = com.helger.peppol.identifier.ObjectFactory._RecipientIdentifier_QNAME;
  private static final QName QNAME_SENDERID = com.helger.peppol.identifier.ObjectFactory._SenderIdentifier_QNAME;
  private static final QName QNAME_DOCUMENTID = com.helger.peppol.identifier.ObjectFactory._DocumentIdentifier_QNAME;
  private static final QName QNAME_PROCESSID = com.helger.peppol.identifier.ObjectFactory._ProcessIdentifier_QNAME;
  ...
  public static Document createHeadersDocument (@Nonnull final IMessageMetadata aMetadata) throws JAXBException
  {
    ...
    final com.helger.peppol.identifier.ObjectFactory aObjFactory = new com.helger.peppol.identifier.ObjectFactory ();
